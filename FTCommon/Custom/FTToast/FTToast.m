...
- (UILabel *)laebl {
    if (!_laebl) {
        ...
        _laebl.font = self.font?self.font:[UIFont systemFontOfSize:16];
...
+ (void)showToastWithString:(NSString *)string {
    ...
    CGSize size = [NSString sizeWithText:string font:[FTToast share].font?[FTToast share].font:[UIFont systemFontOfSize:16] maxSize:CGSizeMake(SCREENWIDTH-60, 35)];
