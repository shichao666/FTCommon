...
# /*.{h,m}
# /**/*
s.source_files = "FTCommon", "FTCommon/Category/*.{h,m}","FTCommon/Custom/*.{h,m}","FTCommon/Custom/FTPushAnimation/*.{h,m}","FTCommon/Custom/FTToast/*.{h,m}","FTCommon/Manager/*.{h,m}" 
